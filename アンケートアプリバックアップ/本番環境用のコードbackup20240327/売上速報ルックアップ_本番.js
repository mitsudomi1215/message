...
// ヘッダーここまで-------------------------------------------------------------------------
  ...
  let lookUpParams = {
    ...
    {to: '時間数_計画' , from: '人時単日_計画'},
    {to: '時間数_週マネ' , from: '週マネ単日_人時数実績'},
    {to: '時間数_実績' , from: '人時単日_実績'},
    {to: '時間数_要コン' , from: '人時単日_要コン'},
    {to: '欠員', from: '単日_欠員'}
    ],
    viewFields: ['店番', '店名','日付', '売上単日_計画','週マネ単日_売上見込','売上単日_実績','売上単日_達成率','人時単日_計画','週マネ単日_人時数実績','人時単日_実績','人時単日_要コン','単日_欠員'], //modalに表示するフィールド//変更
